...
Therefore, the switches memory constraints in time-triggered multi-hop networks~\cite{DBLP:conf/rtss/2010} are not included in our scheduling constraints. 
