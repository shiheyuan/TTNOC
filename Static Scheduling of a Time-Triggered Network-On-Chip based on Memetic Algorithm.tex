...
\begin{figure}[!t]
	...
	\caption{The percentage of failed scheduling}
	\label{f:fail}
\end{figure}
...
In our future work,
the mapping between messages and nodes and routing strategy can be integrated to the TTNoC scheduling.
And the different TTNoC architecture,
i.e. torus, hypercube,
and different local search strategy may be also considered in our experiment.
