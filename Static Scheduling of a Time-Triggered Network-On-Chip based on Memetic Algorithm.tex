...
A TTNoC is a system with a set of $\mathit{m}$ real-time tasks/applications $ \Gamma = \{\tau_{1},\dots,\tau_{m} \}$ mapped on a multi-core interconnection platform, composed of a set of identical processing elements interconnected by physical links and network switches. The topologies of a TTNoC can be either regular or irregular. 
