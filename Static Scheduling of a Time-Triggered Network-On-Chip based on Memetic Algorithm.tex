...
Since the score represents the conflict times, the smaller the score, the better the individual is.
...
After marking two of individual with varying offset $s_0.\phi$,
 we select the individual whose score is 2 as the updated $in_0$ because this individual owns the minimum score among the candidates which reallocate the $s_0,\phi$.
%\begin{figure}[!t]
%	\centering
