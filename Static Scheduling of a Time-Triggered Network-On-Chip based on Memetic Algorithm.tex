...
the failed scheduling of MA is about 30\% in compare with the general genetic algorithm.
...
It should be noted that the rate is the average result of the 15 test cases for the same architecture and the number of messages but different generated messages.
...
We present our memetic algorithm and evaluate with various random generated messages on different scales of mesh-based TTNoC.
